...
async function apiRequest(endpoint, options = {}) {
    const token = ("TURBOPACK compile-time truthy", 1) ? localStorage.getItem('auth_token') : ("TURBOPACK unreachable", undefined);
    const headers = {
...
const courses = {
    ...
    getLessons: (courseId, moduleId)=>apiRequest(`/courses/${courseId}/modules/${moduleId}/lessons`)
};
const progress = {
    getUserProgress: ()=>apiRequest('/progress'),
    updateProgress: (lessonId, completed)=>apiRequest('/progress', {
            method: 'POST',
            body: JSON.stringify({
                lesson_id: lessonId,
                completed
...
function AuthProvider({ children }) {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "AuthProvider.useEffect": ()=>{
            const token = __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["auth"].getToken();
            if (token) {
    ...
    const login = async (username, password)=>{
        const response = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["auth"].login(username, password);
        if (response.error) {
    ...
    const logout = ()=>{
        __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["auth"].logout();
        setUser(null);
...
//# sourceMappingURL=%5Broot-of-the-server%5D__4c8a16ff._.js.map